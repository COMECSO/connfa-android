...
public class DrawerMenu {
    public static final int MY_SCHEDULE_POSITION = 3;
    ...
    public static List<DrawerMenuItem> getNavigationDrawerItems() {
        ...
        result.add(new DrawerMenuItem(R.string.social_events, R.drawable.menu_icon_social_events, R.drawable.menu_icon_social_events_sel, EventMode.Social, true));
        ...
        result.add(new DrawerMenuItem(R.string.social_media, R.drawable.menu_icon_social_media, R.drawable.menu_icon_social_media_sel, EventMode.SocialMedia, false));
