...
import com.lemberg.connfa.model.database.AbstractEntity;
import com.lemberg.connfa.model.database.AbstractEntityDAO;
import com.lemberg.connfa.util.CursorStringParser;
...
public class Event extends AbstractEntity<Long> implements Comparable<Event>{
    ...
    public static String convertTime(Calendar time) {
        if (time != null) {
            SimpleDateFormat format = new SimpleDateFormat("kk:mm", Locale.forLanguageTag("es-Es"));
