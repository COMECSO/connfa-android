...
import com.lemberg.connfa.model.EventGenerator;
import com.lemberg.connfa.model.PreferencesManager;
import com.lemberg.connfa.model.data.Event;
import com.lemberg.connfa.ui.activity.EventDetailsActivity;
import com.lemberg.connfa.ui.adapter.EventsAdapter;
import com.lemberg.connfa.ui.adapter.item.EventListItem;
import com.lemberg.connfa.ui.adapter.item.SimpleTimeRangeCreator;
...
public class EventFragment extends Fragment implements EventsAdapter.Listener{
    ...
    private void onItemClick(int position) {
        ...
        if (item.getEvent() != null && item.getEvent().getId() != 0) {
            ...
            EventDetailsActivity.startThisActivity((AppCompatActivity) getActivity(), event.getId(), mDay, true);
        }
    }
